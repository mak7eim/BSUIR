...
void MainWindow::on_button_memcpy_clicked() {
    ...
    QMessageBox::information(nullptr, "Результат",
                             QString("С помощью метода memcpy n символов было "
                                     "скопировано из String1 в QLineEdit"));
}
...
void MainWindow::on_button_memmove_clicked() {
    ...
    QMessageBox::information(nullptr,
                             "Результат                                        "
                             "                                  ",
                             QString("С помощью метода memmove данные были "
                                     "перемещены из String1 в QLineEdit"));
}
...
void MainWindow::on_button_strcpy_clicked() {
    ...
    QMessageBox::information(nullptr,
                             "Результат                                        "
                             "                                  ",
                             QString("С помощью метода strcpy данные были "
                                     "перемещены из String1 в QLineEdit"));
}
...
void MainWindow::on_button_strncpy_clicked() {
    ...
    QMessageBox::information(nullptr,
                             "Результат                                        "
                             "                                  ",
                             QString("С помощью метода strncpy n символов было "
                                     "скопировано из String1 в QLineEdit"));
}
...
void MainWindow::on_button_strcat_clicked() {
    ...
    QMessageBox::information(nullptr, "Результат",
                             QString("Строки были успешно объединены"));
}


void MainWindow::on_button_memset_clicked() {
    QByteArray byteArray = ui->ln_str1->text().toUtf8();
    if (ui->ln_str2->text().isEmpty() || ui->ln_str1->text().isEmpty()) {
        QMessageBox::warning(nullptr, "Результат",
                             QString("Заполните поля String!!!"));
        return;
    }
    ...
    QMessageBox::information(
        nullptr, "Результат",
        QString("Строка была успешно заполнена первым символом String 2"));
}


void MainWindow::on_button_strtok_clicked() {
    QByteArray byteArray = ui->ln_str1->text().toUtf8();
    if (ui->ln_str2->text().isEmpty() || ui->ln_str1->text().isEmpty()) {
        QMessageBox::warning(nullptr, "Результат",
                             QString("Заполните поля String!!!"));
    ...
    QMessageBox::information(nullptr, "Результат",
                             QString("Строка была успешно разбита на токены"));
}
...
void MainWindow::on_button_strcoll_clicked() {
    ...
    int result =
        cstring->strcoll(byteArray1.constData(), byteArray2.constData());
...
void MainWindow::on_button_strxfrm_clicked() {
    QByteArray byteArray = ui->ln_str1->text().toUtf8();
    size_t n = ui->spb_N->value();
    ...
    QMessageBox::information(nullptr, "Результат",
                             QString("Строка была успешно преобразована"));
}
...
void MainWindow::on_button_strlen_clicked() {
    ...
    QMessageBox::information(nullptr, "Результат",
                             QString("Длина строки: %1").arg(length));
}
...
void MainWindow::on_button_strcmp_clicked() {
    ...
    QByteArray byteArray2 = ui->ln_str2->text().toUtf8();
    int result =
        cstring->strcmp(byteArray1.constData(), byteArray2.constData());
    QString message;
    if (result == 0) {
        message = "Строки равны";
    } else if (result < 0) {
...
void MainWindow::on_button_strncmp_clicked() {
    ...
    size_t n = ui->spb_N->value();
    int result =
        cstring->strncmp(byteArray1.constData(), byteArray2.constData(), n);
    QString message;
    if (result == 0) {
        message = "Первые " + QString::number(n) + " символов равны";
    } else if (result < 0) {
        message = "Первые " + QString::number(n) +
                  " символов первой строки меньше второй";
    } else {
        message = "Первые " + QString::number(n) +
                  " символов первой строки больше второй";
    }
    QMessageBox::information(nullptr, "Результат", message);
}
...
void MainWindow::on_button_memcmp_clicked() {
    ...
    size_t n = ui->spb_N->value();
    int result =
        cstring->memcmp(byteArray1.constData(), byteArray2.constData(), n);
    QString message;
    if (result == 0) {
        message = "Первые " + QString::number(n) + " байт равны";
    } else if (result < 0) {
        message = "Первые " + QString::number(n) +
                  " байт первой строки меньше второй";
    } else {
        message = "Первые " + QString::number(n) +
                  " байт первой строки больше второй";
    }
    QMessageBox::information(nullptr, "Результат", message);
}
