...
void MainWindow::on_pushButton_menu_clicked()
{
    ...
    case 10:
        ...
        break;
    default:
        QMessageBox::warning(this, tr("Invalid Input"), "Please enter a number between 0 and 10.");
        break;
    }
    if (menuChoice >= 2 && menuChoice <= 10 && menuChoice % 2 == 0)
    {
        ui->label_3->show();
        ui->textBrowser->show();
    }
